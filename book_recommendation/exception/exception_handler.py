...
class AppException(Exception):
    """
    AppException is a custom exception class used to provide detailed
    information about runtime errors.

    It captures the original exception message along with the source
    file name and line number where the exception occurred. This
    facilitates easier debugging, faster root-cause analysis, and
    improved error tracking in large-scale applications.
